    ...
    var getList = function (data) {
        ...
        $(list).each(function (i) {
            ...
            if(list[i].securities == "关注"){
            	tr += "<td><a href='" + $.url.companyListUrl() + "id=" + list[i].id + "&nameCodeId=" + list[i].codeNum + "&position=privilege"+"'>" + list[i].name + "</a></td>";
            }else{
            	tr += "<td><a style='color:#f57d4b;' href='" + $.url.companyListUrl() + "id=" + list[i].id + "&nameCodeId=" + list[i].codeNum + "&position=privilege"+"'>" + list[i].name + "</a></td>";
            }
...
//	        });
    ...
    var initTable = function () {
        ...
        _url = $.kf.GETQUOTATIONREAL + "?module=ipo" +"&orderByName=" + orderByName + "&orderByType=" + orderByType+ "&tag=" + tag+ "&type=" + realLx + "&special=" + realQs  +  "&keyword=" + keyword;

...
var LawOffice = function(){
    ...
    var getList = function (data) {
        ...
        $(list).each(function (i) {
            tr += "<tr>";
            tr += "<td><a class='basicName' data-name='"+list[i].companyName+"' href='"+ $.url.industryUrl() + "companyName=" + list[i].companyName +"'>" + list[i].name + "</a></td>";
    ...
    var initTable = function () {
        ...
        var _url = $.kf.LAWOFFICE  + "?"+ "orderByName=" + orderByName + "&orderByType=" + orderByType  + "&province=" + province + "&setupTime=" + setupTime + "&keyword=" + keyword + "&start_time=" + start_time + "&stop_time=" + stop_time;
       // new GetTable(_url, $("#pageTool"), "", getList, "get", $("#tableTwo"),lastPage).init();
        $.getTable({
        	url:_url,//url

...
(function($) {
	...
	var GetTable = function(options) {
		...
		this.topPageNum = options.topPageNum;
		...
		getListAjax: function() {
			...
			$.kf.ajax({
				...
				processResponse: function(data) {
					...
					if(_this.tbodyId.parents(".page-content-par").find(".allListSo").size()) {
						if(_this.tbodyId.parents(".tab-pane").size()) {
							_this.tbodyId.parents(".tab-pane").find(".allListSo").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						} else {
							_this.tbodyId.parents(".page-content-par").find(".allListSo").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						}
					} else if(_this.tbodyId.parents(".page-content-par").find(".allList").size()) {
						if(_this.tbodyId.parents(".tab-pane").size()) {
							_this.tbodyId.parents(".tab-pane").find(".allList").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						} else {
							_this.tbodyId.parents(".page-content-par").find(".allList").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						}
					} else {
			...
			this.el.Paging({
				...
				callback: function(page, size, count) { //'当前第 ' +page +'页,每页 '+size+'条,总页数：'+count+'页'
					...
					if(_this.el.parents(".page-content-par").find(".allListSo").size()) {
						if(_this.el.parents(".tab-pane").size()) {
							_this.el.parents(".tab-pane").find(".allListSo").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						} else {
						...
						if(_this.el.parents(".tab-pane").size()) {
							_this.el.parents(".tab-pane").find(".allList").after("<div class='row allList pageTotalDiv'><div class='hang-title'>共<span class='pageTotal'>" + _this.totalPage + "</span>条结果</div></div>");
						} else {

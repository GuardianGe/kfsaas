...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(KfStyle.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (KfStyle.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (KfStyle.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", KfStyle.getGlobalCssPath() + file + ".css");
